...
<details open>
<summary><b>1. The Dark Side: Offensive Operations & Web Auditing</b></summary>
<br>
I leverage an attacker's mindset to expose vulnerabilities in complex systems before they are weaponized.
<br><br>
<img src="https://img.shields.io/badge/Burp_Suite-FF6633?style=for-the-badge&logo=portswigger&logoColor=white" alt="Burp" />
<img src="https://img.shields.io/badge/Caido-181717?style=for-the-badge&logo=rust&logoColor=white" alt="Caido" />
<img src="https://img.shields.io/badge/Kali_Linux-557C94?style=for-the-badge&logo=kali-linux&logoColor=white" alt="Kali" />
<img src="https://img.shields.io/badge/Metasploit-000000?style=for-the-badge&logo=metasploit&logoColor=white" alt="Metasploit" />
</details>

<details open>
<summary><b>2. Frontier Threat Research: AI Security (2023-2026)</b></summary>
<br>
...
<img src="https://img.shields.io/badge/Protegrity-0052FF?style=for-the-badge&logo=shield&logoColor=white" alt="Protegrity" />
...
sequenceDiagram
    ...
    participant SASE as Netskope SASE
    participant API as Enterprise API
    participant Vault as Tokenization Vault

    User->>SASE: Initiates Connection (TLS 1.3)
    SASE->>SASE: Posture & UEBA Check
    alt Threat Detected
        SASE-->>User: Drop Connection (Alert SOC)
    else Posture Validated
        SASE->>API: Forward Traffic
        API->>Vault: Detokenize Payload
        Vault-->>API: Secure Enclave Response
        API-->>SASE: Render Application
